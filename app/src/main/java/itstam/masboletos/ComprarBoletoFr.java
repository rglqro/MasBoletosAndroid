...
public class ComprarBoletoFr extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.fragment_comprar_boleto, container, false);
        ...
        urlimagMapa=bundle.getString("indiceimagen");
    ...
    public void onClick(View v) {
        ...
        if(v==BtMas){
            ...
            } else{BtMenos.setClickable(true);}
        }
        if(v==BtMenos){
            if (cantidadBoletos==0){
                BtMenos.setClickable(false);
